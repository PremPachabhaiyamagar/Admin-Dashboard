// importing css file and Navicon components
import './navigation.css';
import Nav from '../navicontamplet/Nav';
...
const Navigation = () => {
  ...
  return (
    <div className={`navigation ${nav && "active"} ${DarkTheme && "dark"}`}>
      ...
      <Nav title={DarkTheme ? "switch to Light Theme" :"switch to Dark Theme"} Icon={MdSwapHoriz} onClick={ChangeTheme} />
    ...
    style={{ fill: '#ffffff', width: '145%', height: 150, transform: 'scaleX(-1)' }}
  >
    <path
